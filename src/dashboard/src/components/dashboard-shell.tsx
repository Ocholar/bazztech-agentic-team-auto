    ...
    return (
        <div className="flex h-screen overflow-hidden bg-white dark:bg-zinc-950 text-slate-900 font-sans">
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                <header className="flex h-16 items-center justify-between border-b px-6 lg:hidden shrink-0 bg-white dark:bg-zinc-950">
                    ...
                    <button 
                        ...
                        className="p-2 rounded-md hover:bg-slate-100 dark:hover:bg-zinc-800"
                    >
                        <Menu size={24} />
                    </button>
                </header>
