        ...
        try {
            const res = await fetch('/api/leads/capture', {
                ...
                body: JSON.stringify({
                    ...
                    metadata: { page: 'enterprise_portal' }
                })
            });
            if (res.ok) {
                logAnalyticsEvent('lead_captured', { type: 'enterprise_playbook_request', page: 'enterprise_portal' });
                setEmailSent(true);
                setTimeout(() => {
    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-red-100">
            ...
            <main className="pt-16 pb-20 md:pb-0">
                ...
                <section className="py-24 px-6 bg-white border-b border-slate-100 overflow-hidden text-slate-900 text-center">
                    <div className="max-w-6xl mx-auto">
                        <div className="mb-20">
                        ...
                        <div className="relative mb-20 text-left">
                            <div className="hidden lg:block absolute top-[60px] left-0 w-full h-1 bg-slate-50 z-0" />
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
                                {[
                                    ...
                                    <div key={i} className="group bg-white border border-slate-100 p-8 rounded-[32px] hover:shadow-xl transition-all">
                        ...
                        <div className="bg-slate-900 rounded-[48px] p-10 md:p-16 text-center text-white relative overflow-hidden">
                ...
                <section className="py-24 px-6 border-b border-slate-100 bg-slate-50">
                    <div className="max-w-6xl mx-auto">
                        <div className="flex items-center gap-4 mb-10">
                            ...
                            <h2 className="text-3xl font-black tracking-tight">Standardized Procurement</h2>
                        </div>
                ...
                <section className="py-24 px-6 border-b border-slate-100 bg-white">
                    <div className="max-w-6xl mx-auto">
                        <div className="flex items-center gap-4 mb-10">
                            <div className="bg-purple-600/10 p-3 rounded-2xl text-purple-600"><Activity size={24} /></div>
                            <h2 className="text-3xl font-black tracking-tight">Day 2 Operational Excellence</h2>
                        </div>
                        <div className="grid md:grid-cols-2 gap-8 mb-16 font-sans">
                            {[
                                { icon: <Activity size={20} className="text-red-500" />, title: 'Real-time Accuracy Guardrails', desc: 'Continuous tracking of model performance. Automated alerts on accuracy drift or hallucination triggers.' },
                                { icon: <RefreshCw size={20} className="text-blue-500" />, title: 'Monthly Workflow Tuning', desc: 'Iteration on system prompts and RAG retrieval parameters based on live production data.' },
                                { icon: <Shield size={20} className="text-emerald-500" />, title: 'SLA-backed Incident Support', desc: 'Dedicated engineering support with 2-hour P1 response times. We fix it before it breaks your flow.' },
                                { icon: <Users size={20} className="text-purple-500" />, title: 'Executive Performance Briefings', desc: 'Quarterly reviews with your leadership team to analyze cost savings and scale additional pipelines.' },
                            ].map((s, i) => (
                                <div key={i} className="flex gap-6 bg-slate-50 border border-slate-100 rounded-[32px] p-8 hover:bg-slate-100 transition-colors">
                                    <div className="flex-shrink-0 bg-white p-3 rounded-2xl h-fit shadow-sm">{s.icon}</div>
                                    <div className="text-left">
                                        <p className="font-black text-lg mb-2">{s.title}</p>
                ...
                <section className="py-24 px-6 bg-slate-50">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-4">
                            {faqs.map((faq, i) => (
                                <div key={i} className="bg-white border border-slate-200 rounded-[24px] overflow-hidden group">
                                    <button
                                        className="w-full text-left px-8 py-6 flex items-center justify-between gap-4 font-bold text-base hover:bg-slate-50 transition-colors"
                                    ...
                                    {openFaq === i && (
                                        <div className="px-8 pb-8 text-slate-500 text-sm leading-relaxed border-t border-slate-100 pt-6 font-medium">
                                            {faq.a}
                                        </div>
                                    )}
                                </div>
