...
const studies = [
    ...
    },
    {
        ...
        client: 'Nairobi Luxury Estates',
        title: 'Lead Onboarding & Document Automation',
        summary: 'Automated 90% of manual lead processing and document intake. Achieved a 6-week payback period and reclaimed 15 hours/week for the operations team.',
        roi: '$28k Annual Savings',
        tags: ['Salesforce', 'n8n', 'Bazz-Doc', 'WhatsApp API'],
    ...
    },
    {
        ...
        client: 'Nairobi Legal Labs',
        title: 'Intake Automation & Billing Optimization',
        summary: 'Reduced client onboarding time by 85% and automated invoice reconciliation. Saved 12 hours/week on manual data entry across 40+ annual cases.',
        roi: '$32k Annual Savings',
        tags: ['Document AI', 'n8n', 'Stripe', 'LegalFlow'],
    ...
    },
    {
        ...
        status: 'deployed',
        industry: 'Healthcare',
        client: 'Coastal Health Clinic',
        title: 'WhatsApp Appointment Orchestration',
        summary: 'Eliminated 90% of appointment no-shows through automated WhatsApp reminders and lead nurturing. ROI achieved in the first 60 days.',
        roi: '90% Fewer No-Shows',
        tags: ['WhatsApp AI', 'n8n', 'Scheduling', 'EHR Integration'],
